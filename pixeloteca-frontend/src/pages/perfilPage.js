    ...
    return(
        <div className="w-full min-h-screen bg-[#1C1C1E] flex flex-col items-center gap-[50px] pt-[10px] lg:pb-[50px] overflow-hidden">
            ...
            <div className="w-full flex items-center justify-center flex-col">
                <a href="/agregar_titulo" className="bg-[orange] w-[60%] h-[40px] rounded-[10px] flex flex-col justify-center items-center text-center md:w-[40%] sm:w-[50%] sm:h-[60px] sm:text-[30px] lg:w-[20%] lg:text-[30px]">Añadir título</a>
